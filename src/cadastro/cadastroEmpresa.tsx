...
type cadastroEmpresaProp = StackCardInterpolationProps<RootStackParamList, 'Login'>;
interface Props{
    navigation: cadastroEmpresaProp;
}

const { width, height } = Dimensions.get('screen');
const CadEmp: React.FC = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{top:10}}>
                ...
                <TextInput placeholder='Digite seu e-mail' style={{borderColor: '#000', borderRadius: 10, borderWidth: 1, width: 350, padding: 5, fontSize: 18, marginTop: 3 }} />
                <Text style={{ fontSize: 20, fontWeight: 'bold', marginTop: 6 }}>
                    Telefone
                </Text>
                <TextInput placeholder='Digite seu Telefone' inputMode='tel' style={{ borderColor: '#000', borderRadius: 10, borderWidth: 1, width: 350, padding: 5, fontSize: 18, marginTop: 3 }} />
                <Text style={{ fontSize: 20, fontWeight: 'bold', marginTop: 6 }}>
                    Senha
                </Text>
                <TextInput placeholder='Digite sua senha' secureTextEntry style={{ borderColor: '#000', borderRadius: 10, borderWidth: 1, width: 350, padding: 5, fontSize: 18, marginTop: 3 }} />
                <Text style={{ fontSize: 20, fontWeight: 'bold', marginTop: 6 }}>
                    CNPJ
                </Text>
                <TextInput placeholder='Digite seu CNPJ' inputMode='numeric' style={{ borderColor: '#000', borderRadius: 10, borderWidth: 1, width: 350, padding: 5, fontSize: 18, marginTop: 3 }} />
                ...
                <TouchableOpacity style={{ backgroundColor: '#00726D', top: 30, borderRadius: 10 }}>
